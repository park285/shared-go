...
func TestGuardedDialContextSplitsDeadlineAcrossCandidates(t *testing.T) {
	...
	base := func(ctx context.Context, _ string, _ string) (net.Conn, error) {
	...
	policy := Policy{Resolver: staticResolver{"example.com": {
...
func TestGuardedDialContextKeepsConnUsableAfterAttemptCancel(t *testing.T) {
	...
	if refusedHost != "127.0.0.1" || refusedPort == port {
