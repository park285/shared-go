...
REMOTE_LIBRARY_ALLOWED_RUN_LINES = frozenset(
    {
        ...
        "bash scripts/ci/check-readme-package-catalog_test.sh",
        "bash scripts/ci/check-docs-contract_test.sh",
...
APP_CANONICAL_WORKFLOW_SHA256 = {
    ...
    "github.com/kapu/hololive-bot-workspace": "9da137cb42e2d43d78e50cefd9e4025e1972adc23bccba0799fbcfe8644fdd5d",
}
